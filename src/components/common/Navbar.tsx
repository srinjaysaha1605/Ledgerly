...
export const Navbar: React.FC<NavbarProps> = ({ onOpenQuickAdd }) => {
  ...
  return (
    <header className="sticky top-0 z-40 bg-[#1A1A2E] border-b-4 border-black px-4 py-3 shadow-[0_4px_0_0_#000]">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
        ...
        >
          <div className="w-10 h-10 bg-[#E94560] border-3 border-black comic-btn flex items-center justify-center text-black font-pixel shadow-[3px_3px_0px_#000] rotate-2">
            <span className="text-xl font-black italic text-black">$</span>
          </div>
          <div>
            <div className="font-comic text-2xl tracking-wider text-[#F9ED69] drop-shadow-[2px_2px_0px_#000] flex items-center gap-1.5 leading-none uppercase italic">
              Ledger<span className="text-[#00D2FF]">ly</span>
            </div>
            <div className="text-[10px] font-pixel text-zinc-400 uppercase tracking-widest mt-0.5">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <button
            ...
            className="comic-btn bg-[#F9ED69] text-black font-comic text-base px-3 sm:px-4 py-1.5 flex items-center gap-1.5 font-bold uppercase tracking-wide hover:bg-[#ffe066]"
          >
          ...
          <button
            ...
            className="comic-btn bg-[#16213E] text-zinc-100 p-2 hover:bg-[#1A1A2E] hover:text-[#F9ED69]"
          >
            {soundEnabled ? <Volume2 className="w-5 h-5" /> : <VolumeX className="w-5 h-5 text-[#E94560]" />}
          </button>
          ...
          <div className="relative">
            <button
              ...
              className="comic-btn bg-[#16213E] text-[#00D2FF] px-2.5 py-1.5 flex items-center gap-1.5 text-xs font-bold font-mono hover:bg-[#1A1A2E]"
            >
